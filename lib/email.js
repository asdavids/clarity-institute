 ...
 *   ZOOM_LINK          – permanent Zoom PMI link
 */
  ...
  const html = `
    <div style="font-family: Georgia, serif; max-width: 560px; margin: 0 auto; color: #2d2d2d;">
      ...
      <div style="background: #f0f4f0; border: 1px solid #c8d8c8; border-radius: 8px; padding: 20px; margin: 24px 0; text-align: center;">
        ...
        <a href="${ZOOM_LINK}" style="display: inline-block; background: #3D5A3E; color: #ffffff; padding: 12px 28px; border-radius: 6px; text-decoration: none; font-family: Arial, sans-serif; font-size: 15px; font-weight: 600; letter-spacing: 0.02em;">
          Join Zoom Session
        </a>
