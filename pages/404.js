...
export default function Custom404() {
  return (
    <>
      <Head>
        <title>Page Not Found — The Clarity Institute</title>
      ...
      <div style={{ minHeight:'100vh', background:C.cream, display:'flex', alignItems:'center', justifyContent:'center', padding:'2rem', fontFamily:"'Jost', sans-serif" }}>
        <div style={{ textAlign:'center', maxWidth:480 }}>
          ...
          <h1 style={{ fontFamily:"'Cormorant Garamond', serif", fontSize:'3rem', color:C.green, fontWeight:300, margin:'0 0 0.5rem' }}>Lost in the Ether</h1>
          ...
          <div style={{ display:'flex', gap:'0.75rem', justifyContent:'center', flexWrap:'wrap' }}>
            ...
            <Link href="/dashboard" style={{
              background:'transparent', color:C.green, padding:'0.8rem 1.75rem',
              borderRadius:8, textDecoration:'none', fontSize:'0.95rem', fontWeight:500,
